...
class AchievementSystemService {
  ...
  async seedDefaultAchievements(): Promise<void> {
    const defaultAchievements = [
      ...
      // PER Excellence Achievements (Payment Error Reduction)
      {
        name: "Error Prevention Rookie",
        slug: "per_rookie",
        description: "Submitted 10 error-free cases using AI guidance",
        category: "per_excellence",
        tier: "bronze",
        iconName: "ShieldCheck",
        iconColor: "#CD7F32",
        criteriaType: "kpi_threshold",
        criteriaConfig: { metric: "perErrorFreeCases", threshold: 10, operator: "gte" },
        pointsAwarded: 50,
        isVisible: true,
        isActive: true,
        sortOrder: 50,
      ...
      {
        name: "Error Prevention Champion",
        slug: "per_champion",
        description: "Submitted 50 error-free cases using AI guidance",
        category: "per_excellence",
        tier: "silver",
        iconName: "ShieldCheck",
        iconColor: "#C0C0C0",
        criteriaType: "kpi_threshold",
        criteriaConfig: { metric: "perErrorFreeCases", threshold: 50, operator: "gte" },
        pointsAwarded: 200,
        isVisible: true,
        isActive: true,
        sortOrder: 51,
      },
      {
        ...
        slug: "per_master",
        description: "Submitted 100 error-free cases with 99%+ accuracy",
        category: "per_excellence",
        tier: "gold",
        iconName: "ShieldCheck",
        iconColor: "#FFD700",
        criteriaType: "kpi_threshold",
        criteriaConfig: { metric: "perErrorFreeCases", threshold: 100, operator: "gte" },
        pointsAwarded: 500,
        isVisible: true,
        isActive: true,
        sortOrder: 52,
      ...
      {
        name: "Nudge Follower",
        slug: "per_nudge_follower",
        description: "Followed AI guidance on 25 risk alerts",
        category: "per_excellence",
        tier: "bronze",
        iconName: "CheckCircle",
        iconColor: "#CD7F32",
        criteriaType: "kpi_threshold",
        criteriaConfig: { metric: "perNudgesFollowed", threshold: 25, operator: "gte" },
        pointsAwarded: 75,
        isVisible: true,
        isActive: true,
        sortOrder: 53,
      ...
      {
        name: "Quality Conscience",
        slug: "per_quality_conscience",
        description: "Maintained error rate below 2% on 50+ cases",
        category: "per_excellence",
        tier: "gold",
        iconName: "Award",
        iconColor: "#FFD700",
        criteriaType: "kpi_threshold",
        criteriaConfig: { metric: "perAccuracyRate", threshold: 98, operator: "gte" },
        pointsAwarded: 300,
        isVisible: true,
        isActive: true,
        sortOrder: 54,
      ...
      {
        name: "LDSS League All-Star",
        slug: "per_ldss_allstar",
        description: "Contributed to top 3 LDSS office in PER League standings",
        category: "per_excellence",
        tier: "gold",
        iconName: "Star",
        iconColor: "#FFD700",
        criteriaType: "kpi_threshold",
        criteriaConfig: { metric: "perLdssLeagueRank", threshold: 3, operator: "lte" },
        pointsAwarded: 400,
        isVisible: true,
        isActive: true,
        sortOrder: 55,
