...
export default function Navigation() {
  ...
  const navigation = [
    { name: "Search Policies", href: "/", icon: Search, current: location === "/" },
          ...
          <div className="flex items-center">
            <Link href="/">
              <div className="flex-shrink-0 flex items-center cursor-pointer" data-testid="nav-logo">
                ...
                <h1 className="ml-3 text-xl font-semibold text-foreground">BenefitsRAG</h1>
              </div>
            </Link>
                ...
                <SheetContent side="right" className="w-[300px] sm:w-[400px]">
                  <div className="flex flex-col space-y-4 mt-6">
                    <div className="flex items-center space-x-3 pb-4 border-b border-border">
                      ...
                      <h2 className="text-lg font-semibold text-foreground">BenefitsRAG</h2>
                    </div>
                    <NavItems mobile />
                  </div>
                </SheetContent>
