...
export const auditLogs = pgTable("audit_logs", {
  ...
  // Creates blockchain-inspired hash chain for tamper detection
  sequenceNumber: serial("sequence_number").notNull(), // Sequential ordering for chain verification
  previousHash: text("previous_hash"), // SHA-256 hash of previous entry (null for first entry)
  entryHash: text("entry_hash").notNull(), // SHA-256 hash of this entry (computed from content + previousHash)
...
export const insertAuditLogSchema = createInsertSchema(auditLogs).omit({
  id: true,
  createdAt: true,
  sequenceNumber: true, // Auto-generated by database
  entryHash: true, // Computed by ImmutableAuditService
});
